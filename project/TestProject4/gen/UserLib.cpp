// This file was automatically generated by gen.py at 10/03/2025, 10:21:26.
...
{
	if (scriptID == EnemyScript_Hash) { return static_cast<void*>(new EnemyScript); }
	...
	else if (scriptID == Player_Hash) { return static_cast<void*>(new Player); }
